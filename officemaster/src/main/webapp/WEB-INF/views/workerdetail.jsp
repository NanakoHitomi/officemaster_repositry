...
<body>
    ...
    <p><%= message %></p>
    <p><strong>従業員名：</strong><%= request.getAttribute("username") %></p>
    <p><strong>部署：</strong><%= request.getAttribute("department") %></p>
    <p><strong>役職:</strong><%= request.getAttribute("grade") %></p><br>
    
    <ul>
      <li><p><a href="officelist">戻る</a></p></li>
